...
function onOpenModal(event) {
  ...
  if (event.target.nodeName === 'IMG') {
  //   return;
  // largeImgRef.classList.add('is-open');
  // }
//  if(event.target.nodeName === 'IMG') {
  largeImgRef.classList.add('is-open');
  largeImgRef.src = largeImgRef.dataset.source;
  // largeImgRef.querySelector('.lightbox__image').src = event.target.src;
  // largeImgRef.querySelector('.lightbox__image').alt = event.target.alt;
  }
